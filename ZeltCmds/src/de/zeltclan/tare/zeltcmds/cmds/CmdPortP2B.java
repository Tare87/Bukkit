...
public class CmdPortP2B extends CmdParent {
	...
	public CmdPortP2B(Permission p_perm, Permission p_permExt, RequireListener p_listener, String p_msg) {
		super(ZeltCmds.getLanguage().getString("description_port_p2b"), p_perm, p_permExt, p_listener);
	...
	protected void executeConsole(CommandSender p_sender, String p_cmd, String[] p_args) {
		switch (p_args.length) {
			...
			case 1:
				...
				this.getPlugin().getLogger().warning(ZeltCmds.getLanguage().getString("usage_Player_Player", new Object[] {p_cmd}));
				break;
			case 2:
				...
				if (bed_player.getFirstPlayed() == 0) {
					this.getPlugin().getLogger().warning(ZeltCmds.getLanguage().getString("player_not_found", new Object[] {p_args[1]}));
					break;
				}
	...
	protected String executePlayer(Player p_player, String p_cmd, String[] p_args) {
		switch (p_args.length) {
			...
			case 1:
				...
				p_player.sendMessage(ChatColor.RED + "[" + this.getPlugin().getName() + "] " + ZeltCmds.getLanguage().getString("usage_Player_Player", new Object[] {"/" + p_cmd}));
				break;
			case 2:
				if (this.checkPerm(p_player, false)) {
					...
					if (bed_player.getFirstPlayed() == 0) {
						p_player.sendMessage(ChatColor.RED + "[" + this.getPlugin().getName() + "] " + ZeltCmds.getLanguage().getString("player_not_found", new Object[] {p_args[1]}));
						break;
					}
					if (bed_player.getBedSpawnLocation() == null) {
