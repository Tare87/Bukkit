...
public class CmdPortP2S extends CmdParent {
	...
	public CmdPortP2S(Permission p_perm, Permission p_permExt, RequireListener p_listener, String p_msg) {
		super(ZeltCmds.getLanguage().getString("description_port_p2s"), p_perm, p_permExt, p_listener);
	...
	protected void executeConsole(CommandSender p_sender, String p_cmd, String[] p_args) {
		switch (p_args.length) {
			...
			case 1:
				...
				final Location spawn = LocationUtils.getSafeLocation(player.getWorld().getSpawnLocation());
				if (spawn == null) {
