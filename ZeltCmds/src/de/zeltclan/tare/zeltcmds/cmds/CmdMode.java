...
public final class CmdMode extends CmdParent {
	...
	public CmdMode(Types p_type, Permission p_perm, Permission p_permExt, String p_msg) {
		super(ZeltCmds.getLanguage().getString("description_mode_" + p_type.name().toLowerCase()), p_perm, p_permExt);
		type = p_type;
