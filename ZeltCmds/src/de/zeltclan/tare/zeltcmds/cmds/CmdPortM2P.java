...
public class CmdPortM2P extends CmdParent {
	...
	public CmdPortM2P(Permission p_perm, Permission p_permExt, String p_msg) {
		super(ZeltCmds.getLanguage().getString("description_port_m2p"), p_perm, p_permExt);
			...
			case 1:
				if (this.checkPerm(p_player, false)) {
					...
					if (off_player.isOnline()) {
						...
						return ZeltCmds.getLanguage().getString("log_port_m2p", new Object[] {p_player.getDisplayName(), player.getDisplayName()});
					} else {
