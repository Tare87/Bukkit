	...
	protected String executePlayer(Player p_player, String p_cmd, String[] p_args) {
		switch (p_args.length) {
			case 0:
				...
				MessageUtils.warning(p_player, "[" + this.getPlugin().getName() + "] " + ZeltCmds.getLanguage().getString("usage_Distance", new Object[] {"/" + p_cmd}));
				break;
			case 1:
				if (this.checkPerm(p_player, false)) {
					...
					return "[" + this.getPlugin().getName() + "] " + ZeltCmds.getLanguage().getString("log_port_mod", new Object[] {distance, target.getWorld().getName(), p_player.getDisplayName()});
				}
				break;
			default:
